...
🌐 Language : 🇯🇵 日本語 / 🇺🇸 [English](instructions_e.html)
...
#### 通常モードへ切り替え (編集モードの終了)
- 編集モード時の[鍵アイコン](#editend)(全体(縦型)メニューの一番上)をタップ
...
- アイコンサイズ
- ラベルの表示/非表示
- [アイコン素材から選択](#icongenerator)

<a id="icongenerator"></a>
##### アイコン素材から選択
- 別アプリ Soulful Icon Generator で作成されたアイコンを指定できます。
