...
- 2026-06-23 Ver.1.0.0-1  
  ...
  Added ascending/descending order and display change functions to the App drawer  
  Fixed unnecessary debug display.  
- 2026-05-01 Ver.0.9.3
  Fixed the app to appear in the drawer immediately after registration  
  Removed the "keep on top" setting  
  Slightly improved screen display speed  
- 2026-04-24 Ver 0.9.2  
  Added infinite screen looping feature.  
  Added a brief tutorial.  
- 2026-04-20 Ver 0.9.1  
  English support available  
- 2026-04-20 Ver 0.9.0  
